...
function animate(startPoint, endPoint) {
    ...
    planePath2 = new google.maps.Polyline({
        path: [sP, eP],
        strokeColor: '#0f0',
        strokeWeight: 0,
        icons: [{
    ...
    planePath3 = new google.maps.Polyline({
        path: [sP, eP],
        strokeColor: '#0f0',
        strokeWeight: 0,
        icons: [{
    ...
    planePath4 = new google.maps.Polyline({
        path: [sP, eP],
        strokeColor: '#0f0',
        strokeWeight: 0,
        icons: [{
    ...
    planePath5 = new google.maps.Polyline({
        path: [sP, eP],
        strokeColor: '#0f0',
        strokeWeight: 0,
        icons: [{
...
function go() {
    ...
    animIndex = 0;
    animate(
            document.getElementById('from').options[document.getElementById('from').selectedIndex].value,
            document.getElementById('to').options[document.getElementById('to').selectedIndex].value
        );
}